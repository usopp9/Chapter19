...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerReceiver(batteryReciver,new IntentFilter(Intent.ACTION_POWER_CONNECTED));
        registerReceiver(batteryReciver, new IntentFilter(Intent.ACTION_POWER_DISCONNECTED));
    }
